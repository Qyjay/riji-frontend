...
用户通过拍照、语音、文字收集日常素材，AI 对话也会自动转为素材，AI 自动生成精美日记，并可将日记转化为漫画、小说、分享卡片等衍生内容。内置 AI 对话助手、校园广场（搜索/刷新/分身推荐）、情绪追踪、纪念日管理、社交匹配等功能。

### ✨ 核心功能

| 模块 | 功能 |
|------|------|
| 📝 **AI 日记** | 素材收集（拍照/语音/文字/对话）→ AI 自动生成日记 → 支持修改（次数限制）→ 情绪趋势图 |
| 🎨 **衍生创作** | 日记一键生成漫画、小说章节、分享卡片 |
| 💬 **AI 对话** | 智能生活助手，流式打字机效果，对话自动转素材参与日记生成 |
| 🏫 **校园广场** | 帖子信息流（找搭子/求助/分享/恋爱）+ 页内搜索 + 下拉刷新 + AI 分身推荐 |
| 🤖 **AI 分身** | 自动浏览广场 → 匹配感兴趣的帖子 → 分身对话 → 推荐给用户 |
...
│   │   ├── ChatDetailSheet.vue   #   对话详情 Bottom Sheet（素材展开对话）
│   │   ├── DiaryCard.vue         #   日记卡片
...
| Diary | 10 | AI 生成日记、日记 CRUD、情绪趋势、信息提取、衍生内容、搜索 |
| Chat | 4 | AI 对话、聊天历史、关闭对话段、对话段消息详情 |
| AI | 2 | TTS、运势 |
| User | 8 | 用户资料、成就、成长数据、设置（含对话素材设置）、学期报告、画像 |
| Social | 9 | 匹配、消息、匹配报告、搭子、用户画像 |
| Anniversary | 5 | 纪念日 CRUD、那年今日 |
| Plaza | 6 | 帖子列表（含搜索）、帖子详情、创建帖子、点赞、评论列表、添加评论 |
| Avatar | 8 | 分身记忆 CRUD、分身状态、推荐匹配、侧写 |
| Study | 6 | 番茄钟、待办 |
