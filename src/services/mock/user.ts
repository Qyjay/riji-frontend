...
export function getGrowthData(): GrowthData {
  return {
    ...
    stats: {
      ...
      pomodoroCount: 247,
      todoCount: 86,
      completedTodoCount: 72,
      chatRounds: 168,
      derivativeCount: 18,
      comicCount: 6,
      achievementCount: 8,
      plazaPostCount: 12,
      plazaCommentCount: 39,
      acceptedMatchCount: 3,
    },
    skills: [
      { key: 'record', name: '记录', value: 88, basis: '日记和素材沉淀' },
      { key: 'reflection', name: '自省', value: 76, basis: '情绪与复盘内容' },
      { key: 'social', name: '连接', value: 64, basis: '广场与搭子互动' },
      { key: 'creation', name: '创作', value: 71, basis: '衍生内容生成' },
    ],
    chart: [
      { date: '2026-03-16', label: '周一', xp: 32, diaries: 1, materials: 2, pomodoros: 3 },
      { date: '2026-03-17', label: '周二', xp: 48, diaries: 1, materials: 4, pomodoros: 5 },
      { date: '2026-03-18', label: '周三', xp: 24, diaries: 0, materials: 3, pomodoros: 2 },
      { date: '2026-03-19', label: '周四', xp: 56, diaries: 1, materials: 5, pomodoros: 4 },
      { date: '2026-03-20', label: '周五', xp: 40, diaries: 1, materials: 2, pomodoros: 3 },
      { date: '2026-03-21', label: '周六', xp: 68, diaries: 2, materials: 6, pomodoros: 2 },
      { date: '2026-03-22', label: '周日', xp: 52, diaries: 1, materials: 4, pomodoros: 4 },
    ],
    milestones: [
      { id: 'm1', name: '连续记录 7 天', done: true, date: '3月6日' },
      { id: 'm2', name: '形成第一版分身画像', done: true, date: '3月12日' },
      { id: 'm3', name: '完成一次 AtoA 连接', done: true, date: '3月18日' },
      { id: 'm4', name: '连续记录 30 天', done: false, date: '' },
    ],
    timeline: [
      { date: '2026-03-22', type: 'diary', title: '完成本周回顾', description: '整理了 7 天的生活线索', xp: 24, sourceId: 'd1' },
      { date: '2026-03-20', type: 'social', title: '认识新的学习搭子', description: '双方确认后开始真人交流', xp: 30, sourceId: 'm1' },
      { date: '2026-03-18', type: 'avatar', title: '分身画像更新', description: '新增摄影与夜跑兴趣', xp: 18, sourceId: 'a1' },
    ],
    todayXp: 52,
    xpBreakdown: [
      { label: '生活记录', xp: 20 },
